...
class TestHTMLSanitize(unittest.TestCase):
    ...
    def test_removes_unsafe_attributes(self):
        input_html = "<div><p style='width: 20;background-image: `wingnut.png`;'>This has a style tag with unsafe attributes</p></div>"
        expected_output = "<div><p style=\"width: 20;\">This has a style tag with unsafe attributes</p></div>"
    ...
    def test_does_not_remove_allowed_tags(self):
        ...
        expected_output = "<div><p>This has a <a href=\"#\">link</a> and some <em>emphasis</em>.</p></div>"
        sanitized_output = utils.remove_inline_scripts(input_html)
        self.assertEqual(expected_output, sanitized_output)
